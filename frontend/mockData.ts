...
export const visits: Visit[] = [
  {
    ...
    steps: [
      ...
      { id: 'vs-2', type: 'main_item', itemId: 'i-2', title: 'The Etruscan Situla', order: 1 },
      { id: 'vs-3', type: 'transition', title: 'Move to Egyptian Gallery', description: 'Take the stairs to the first floor, turn right.', order: 2 },
      { id: 'vs-4', type: 'main_item', itemId: 'i-5', title: 'Egyptian Mummy of Usai', order: 3 },
      { id: 'vs-5', type: 'optional_item', itemId: 'i-6', title: 'Roman Mosaic Floor', order: 4 },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'vs-7', type: 'main_item', itemId: 'i-4', title: 'Meet the Mummy!', order: 1 },
      { id: 'vs-8', type: 'main_item', itemId: 'i-1', title: 'A Very Old Bucket', order: 2 },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'vs-10', type: 'main_item', itemId: 'i-3', title: 'The Etruscan Situla (Extended)', order: 1 },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'vs-12', type: 'main_item', itemId: 'i-7', title: 'San Luca Madonna', order: 1 },
      { id: 'vs-13', type: 'transition', title: 'Walk to Room 15', order: 2 },
      { id: 'vs-14', type: 'main_item', itemId: 'i-10', title: "Raphael's Ecstasy", order: 3 },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'vs-16', type: 'main_item', itemId: 'i-11', title: "Morandi's Still Life", order: 1 },
    ],
